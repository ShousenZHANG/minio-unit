package com.minio.minio_test.admin;
...
import com.minio.minio_test.admin.messages.DataUsageInfo;
...
public class MinioAdminClient {
    ...
    private Response execute(
        ...
        if (traceStream != null) {
            ...
            traceStream.println(traceBuilder);
        }
        ...
        throw new RuntimeException("Request failed with response: " + Objects.requireNonNull(response.body()).string());
    }
    ...
    public UserInfo getUserInfo(String accessKey)
        ...
        try (Response response =
            ...
            byte[] jsonData = Objects.requireNonNull(response.body()).bytes();
    ...
    public static final class Builder {
        ...
        public Builder endpoint(String endpoint, int port, boolean secure) {
            ...
            if (port < 1 || port > 65535) {
                throw new FileTransferException(ResultResponse.error().getCode(), "port must be in range of 1 to 65535");
            }
